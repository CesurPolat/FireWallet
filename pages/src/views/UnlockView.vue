...
export default {
    ...
    methods: {
        unlock: function () {
            if (window.API.Unlock(this.pass)) {
...
<template>
    ...
    <div class="flex flex-col items-center">
        ...
        <router-link to="create" class="font-medium text-red-600 underline dark:text-red-500 hover:no-underline">Forgot Password?</router-link>
    </div>
    <div class="flex flex-col items-center fixed bottom-0 left-0 right-0">
        <a href="https://github.com/CesurPolat" target="_blank">github.com/CesurPolat</a>
    </div>
</template>